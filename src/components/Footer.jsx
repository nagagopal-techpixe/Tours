  ...
  />
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-200">
            <li onClick={() => navigateTo('about')} className="cursor-pointer transition text-base text-gray-200 hover:text-amber-300">About Us</li>
            <li onClick={() => navigateTo('packages')} className="cursor-pointer transition text-base text-gray-200 hover:text-amber-300">Tour Packages</li>
            <li className="cursor-pointer transition text-base text-gray-200 hover:text-amber-300">Destinations</li>
            <li className="cursor-pointer transition text-base text-gray-200 hover:text-amber-300">Blog</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-200">
            <li className="cursor-pointer transition text-base text-gray-200 hover:text-amber-300">Privacy Policy</li>
            <li className="cursor-pointer transition text-base text-gray-200 hover:text-amber-300">Terms & Conditions</li>
            <li className="cursor-pointer transition text-base text-gray-200 hover:text-amber-300">Payment Security</li>
            <li className="cursor-pointer transition text-base text-gray-200 hover:text-amber-300">Admin Panel</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-200">
            <li className="flex items-start gap-3">
              <MapPin size={16} className="mt-1 text-white-300 flex-shrink-0  text-base text-gray-200 " />
              <span>Pno C17 Paschim Vihar Kesopura A Block Ajmer road Jaipur</span>
            </li>
            <li className="flex items-center gap-3">
              <Phone size={16} className="text-white-300 flex-shrink-0  text-base text-gray-200 " />
              <span>+91 90014 59519</span>
            </li>
            <li className="flex items-center gap-3">
              <Mail size={16} className="text-white-300 flex-shrink-0  text-base text-gray-200 " />
